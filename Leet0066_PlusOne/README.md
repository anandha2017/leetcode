...
- This is a problem about array manipulation and handling carries in addition.
- Think carefully about edge cases, especially when all digits are 9s.
- Challenge yourself to solve it efficiently with O(n) time complexity.
